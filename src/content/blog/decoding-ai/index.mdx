...
layer and capitalize on this profound technological shift.1
...
the AI accelerator market and a staggering 92% of the data center GPU market.1
...
models and sells for as much as $40,000 per unit.1
...
| **Intel** | INTC | &lt;2% | Gaudi | -21% | -39% | Cost Leadership (Price-Focused Alternative) |
...
| **Google Cloud (GCP)** | 13%1 | $13.6B | 32% | ~21% | ~$54B |
...
The company reported product revenue of $2. billion for fiscal 2024,
...
fiscal 2024 but remains unprofitable, with a net profit margin of -18.%.
